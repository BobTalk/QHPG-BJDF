...
var userDao = require('../../dao/bdmanage_dao/userDao');
module.exports = {
    //添加用户
    saveUserInfo: function (req, res, next) {
        ...
        userDao.saveInfo(param, function (err, result) {
            if (err != null) {
    ...
    removeUserInfo: function (req, res, next) {
        ...
        userDao.removeInfo(param, function (err, result) {
            if (err != null) {
                $util.resJSONError(err, res);
                return;
            }
    ...
    updataUserInfo: function (req, res, next) {
        ...
        userDao.updataInfo(param, function (err, result) {
            if (err != null) {
                $util.resJSONError(err, res);
                return;
            }
