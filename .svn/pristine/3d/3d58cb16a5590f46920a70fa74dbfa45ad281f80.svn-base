...
define(function (require) {
    "use strict";
    var tpl = require('text!tpl/demo/projectList.html'),
...
//                        dataIndex : "ZW",
                ...
                initTableEventsCall : function(){
                    ...
                    me.$(".editData").click(function(_event){
                        ...
                        location.href="#dataNewTask/2/"+ needEditId;
                    });
                    //为table中的取消发布按钮添加事件：
                    ...
                    me.$(".checkProject").click(function(_event){
                        ...
                        location.href="#dataNewTask/3/"+ needEditId;
                    });
                }
            };
