...
var parentDao = require('../../dao/bdmanage_dao/parentDao');
module.exports = {
    //添加用户
    saveUserInfo: function (req, res, next) {
        ...
        parentDao.saveInfo(param, function (err, result) {
            if (err != null) {
    ...
    removeUserInfo: function (req, res, next) {
        ...
        parentDao.removeInfo(param, function (err, result) {
            if (err != null) {
                $util.resJSONError(err, res);
                return;
            }
    ...
    updataUserInfo: function (req, res, next) {
        ...
        parentDao.updataInfo(param, function (err, result) {
            if (err != null) {
                $util.resJSONError(err, res);
                return;
            }
