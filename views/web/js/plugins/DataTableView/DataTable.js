...
define(function(require, module, exports) {
	...
	var tableTpl = require('text!../../js/plugins/DataTableView/datatable.xml');
	var pagingTpl = require('text!../../js/plugins/DataTableView/paging.xml');
...
//			var head = "<tr><th  style='width: 5px;'>" + (showCheckAll ? "<input type=checkbox class='dt_ckb_all'></input>" : "") + "</th>";
			...
			var head = "<tr>" + (showCheckAll ? "<th  style='width: 5px; border-right: 0px;'><input type=checkbox class='dt_ckb_all'></input></th>" : "");
			//修改 byWendy 是否显示序号列
			var displayIndex = this.options.displayIndex;
			head += (displayIndex ? "<th  style='width: 30px;'>序号</th>" : "");
