...
var classDao = require('../../dao/bdmanage_dao/classDao');
module.exports = {
    //添加用户
    saveUserInfo: function (req, res, next) {
        ...
        classDao.saveInfo(param, function (err, result) {
            if (err != null) {
    ...
    removeUserInfo: function (req, res, next) {
        ...
        classDao.removeInfo(param, function (err, result) {
            if (err != null) {
                $util.resJSONError(err, res);
                return;
            }
    ...
    updataUserInfo: function (req, res, next) {
        ...
        classDao.updataInfo(param, function (err, result) {
            if (err != null) {
                $util.resJSONError(err, res);
                return;
            }
